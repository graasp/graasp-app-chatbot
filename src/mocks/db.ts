...
import { AccountType, ItemType, PermissionLevel } from '@graasp/sdk';
...
const mockMembers: CompleteMember[] = [
  {
    id: 'current-member',
    name: 'current-member',
    email: '',
...
const defaultMockContext: LocalContext = {
  apiHost: API_HOST,
...
const mockItem: DiscriminatedItem = {
...
export { defaultMockContext, mockItem, mockMembers };
